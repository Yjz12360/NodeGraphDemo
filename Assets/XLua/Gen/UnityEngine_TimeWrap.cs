...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTimeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 1, 20, 6);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "profileTime", _g_get_profileTime);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_profileTime(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushnumber(L, UnityEngine.Time.profileTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
