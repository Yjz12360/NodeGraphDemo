...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 30, 26);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "reflectionProbeIndex", _g_get_reflectionProbeIndex);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "reflectionProbeIndex", _s_set_reflectionProbeIndex);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_reflectionProbeIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.reflectionProbeIndex);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_reflectionProbeIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.reflectionProbeIndex = LuaAPI.xlua_tointeger(L, 2);
