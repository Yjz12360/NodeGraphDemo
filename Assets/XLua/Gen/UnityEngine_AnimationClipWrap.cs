...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 8, 13, 6);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SampleAnimation", _m_SampleAnimation);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SampleAnimationPosition", _m_SampleAnimationPosition);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CompressClipUseACL", _m_CompressClipUseACL);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SupportACL", _m_SupportACL);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useAcl", _g_get_useAcl);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useAcl", _s_set_useAcl);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SampleAnimationPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _time = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.SampleAnimationPosition( _go, _relativePath, _time );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CompressClipUseACL(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _compressLevel = LuaAPI.xlua_tointeger(L, 2);
                    float _errorThreshold = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    gen_to_be_invoked.CompressClipUseACL( _compressLevel, _errorThreshold );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SupportACL(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.SupportACL(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useAcl(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.useAcl);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useAcl(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.useAcl = LuaAPI.lua_toboolean(L, 2);
